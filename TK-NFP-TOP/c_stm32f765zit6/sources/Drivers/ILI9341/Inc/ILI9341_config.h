...
#define TFT_RESET_PIN   SPI1_TFT_RST_Pin  //PD3
#define TFT_DC_PIN      SPI1_TFT_DC_Pin  //PD2
#define TFT_CS_PIN      SPI1_NSS_Pin  //PG10

#define SPI_MASTER                   SPI1
#define SPI_MASTER_CLK               RCC_APB2Periph_SPI

 ...
 * Author: xitre
 *
 * Created on 16 февраля 2018 г., 5:08
 */
...
#define AD7190_COMM_WEN         (1 << 7)           // Write disable.    //changed for me
...
//     uint8_t AD7190_RDY;
//     uint8_t AD7190_ERR;
//     uint8_t AD7190_NOREF;
//     uint8_t AD7190_Parity;
//     uint8_t AD7190_ChannelRead;
// } AD7190_StatusRegInit;
...
// *
// * Communication mode:
// *                   1. Communication register   :       B(01000)
// *                   2. status register          :
// *                   3. mode select              :
// *                   4. mode set                 :
// *                   5. data/data and status     :
// *                   6. AD7190_ID                :
// *                   7. mode GPOCON              :
// *                   8. shitiao                  :
// *                   9. full Range               :
// **************************************************************************
// typedef struct{
//   uint8_t AD7190_WriteMode;
//   uint8_t AD7190_ReadMode;
//   uint8_t AD7190_ModeReg;
//   uint8_t AD7190_StatusReg;
//   uint8_t AD7190_Mode_ID;
//   uint8_t AD7190_GPOCON;
//   uint8_t AD7190_FullRang;
    
// } AD7190_CommunicationReg_Init;


// void AD7190_InitModeConfig(void);
